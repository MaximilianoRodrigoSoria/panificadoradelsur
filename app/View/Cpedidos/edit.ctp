...
<?php echo $this->Form->create('Cpedido'); ?>
	<fieldset>
		<legend><?php echo __('Edit Cpedido'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Cpedido.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Cpedido.id'))); ?></li>
